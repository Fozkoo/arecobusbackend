...
public interface HorarioRepository extends JpaRepository<Horario, Integer> {
    ...
    @Query(value = "SELECT b.idbus, b.numero_linea, b.destino, e.nombre AS empresa_nombre, h.horario, ds.nombre AS dia_nombre " +
            ...
            "WHERE b.idbus = :busId AND ((dsh.dias_semana_iddias_semana = :dia1) OR (dsh.dias_semana_iddias_semana = :dia2))",
            nativeQuery = true)
    List<Horario> buscarHorarios (int busId, int dia1, int dia2);
}
